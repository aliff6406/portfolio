      ...
      >
        <div className="flex max-w-[89vw] flex-col items-center justify-center md:max-w-2xl lg:max-w-[60vw]">
          ...
          <div className="sm:text-md max-w-[40rem] pt-7 md:text-lg">
            <p className="inline">
              as a full-stack software engineer, i&apos;m always curious about
              new technologies and have been spending time lately building
              beautiful and functional web apps. learn more&nbsp;
            </p>
